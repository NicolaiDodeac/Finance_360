...
/**
 * Routes already reachable from the mobile bottom tab bar:
 * Home (/dashboard), Activity (/transactions), Plans (/planning), You (/settings).
 * These are filtered out of the "More" menu so it only shows secondary tools.
 */
